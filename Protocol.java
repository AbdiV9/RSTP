...
public class Protocol {
	...
	public void sendMetadata()
        try {
            dataSeg = new Segment();   // New segment object
            dataSeg = setMeta(true);   //  Segment is marked as metadata
            dataSeg.setFileName(outputFileName); // Name 
            dataSeg.setBatchSize(maxPatchSize);
